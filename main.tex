...
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
Club & \multicolumn{1}{c}{N} & \multicolumn{1}{c}{log(t)} & \multicolumn{1}{c}{t value} & \multicolumn{1}{c}{final log(Y)}
& \multicolumn{1}{c}{$\Delta$Y} & \multicolumn{1}{c}{SD Y} \\ 
\hline \\[-1.8ex]
\multicolumn{7}{c}{2019 Convergence Clubs}\\
Club 1 & 10 &  0.019  & 0.113 &  11.0 & 0.584 & 0.156  \\ 
Club 2 & 24 & 0.108 & 0.710 & 10.7 & 0.461 & 0.133   \\ 
Club 3 & 111 & -0.123   & -1.40 & 10.4 &  0.418 & 0.181 \\ 
Club 4 & 52 & 0.163  & 1.53 & 10.1 & 0.407 & 0.148 \\ 
Club 5 & 79 & -0.096 & -0.968 & 9.88 & 0.340 & 0.229 \\
\hline
\multicolumn{7}{c}{2015 Convergence Clubs}\\
Club 1 & 17 &  0.266  & 2.693 & 10.9 & 0.444  & 0.190 \\ 
Club 2 & 36 & -0.015 & -0.088 & 10.6 & 0.350 & 0.169 \\ 
Club 3 & 93 &  -0.111  & -1.032 & 10.2 & 0.307 & 0.224\\ 
Club 4 & 98 & -0.063  & -0.593 & 10.0 & 0.289 & 0.197\\ 
Club 5 & 29 & -0.099 & -0.638 & 9.77 & 0.236 & 0.263\\ 
\hline \\[-1.8ex]
\end{tabular}
}
\end{table}
...
\resizebox{0.85\textwidth}{!}{\begin{minipage}{\textwidth}
  \caption{Marginal effects of Logistic regression with Sectoral and Human capital variables. Logistic regression with merged Clubs, FAMD imputation and robust standard errors.} 
...
\hline \\[-1.8ex] 
GDP per capita (logs) & $0.011$$^{*}$ & $0.108$$^{***}$ & $1.712$$^{***}$ & $ $-$0.980$$^{***}$ & $ $-$0.851$$^{***}$ \\ 
GFCF (logs)  & $0.000$ & $0.000$ & $ $-$0.001$ & $0.000$ & $0.000$ \\ 
...
\begin{table}[!htbp] \centering 
\resizebox{0.85\textwidth}{!}{\begin{minipage}{\textwidth}
  \caption{Marginal effects of Logistic regression with Geographic determinants. Logistic regression with merged Clubs, FAMD imputation and robust standard errors.} 
...
\hline \\[-1.8ex] 
 & Club 1 & Club 2 & Club 3 & Club 4 & Club 5 \\ 
\hline \\[-1.8ex] 
GDP per capita & $0.023$$^{**}$ & $0.173$$^{***}$ & $1.684$$^{***}$ & $ $-$0.870$$^{***}$ & $ $-$1.010$$^{***}$ \\ 
GFCF (logs) & $ $-$0.001$ & $ $-$0.004$ & $ $-$0.040$ & $0.020$ & $0.024$ \\ 
...
\begin{table}[!htbp] \centering
\resizebox{0.85\textwidth}{!}{\begin{minipage}{\textwidth}
  \caption{Marginal effects: Logistic regression with merged Clubs, FAMD imputation and robust standard errors. 9 regions with no neighbouring regions have been removed.} 
...
GDP per capita (logs) & $0.005$ & $0.076$$^{***}$ & $2.182$$^{***}$ & $ $-$1.453$$^{***}$ & $ $-$0.810$$^{***}$ \\ 
%init\_gfcf & $0$ & $$-$0.001$ & $$-$0.022$ & $0.014$ & $0.008$ \\ 
GFCF (logs) & $0.000$ & $ $-$0.001$ & $ $-$0.022$  & $0.014$ &  $0.008$ \\ 
...
GDP per capita (logs) & $0.013$$^{**}$ & $0.112$$^{***}$ & $1.043$$^{***}$ & $ $-$0.570$$^{***}$ & $  $-$0.599$$^{***}$ \\
%init\_gfcf & $0.001$ & $$-$0.008$ & $$-$0.075$ & $0.041$ & $0.043$ \\ 

GFCF (logs) & $ $-$0.001$ & $ $-$0.008$$^{*}$  & $ $-$0.075$$^{*}$ & $0.041$$^{*}$ & $0.043$$^{*}$ \\
\multicolumn{6}{c}{\textit{Sectoral Variables}}\\
