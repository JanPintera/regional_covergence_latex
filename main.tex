...
This work contributes to the existing literature in two ways. First, it will examine the economic convergence in the EU between two major crises (2008 - 2019). This period was previously not discussed in its entirety. Second, it attempts to draw a connection between various socio-economic characteristics of the EU regions and their relative economic performance.
...
Applying the log $t$ test (Equation \ref{eq10}), the convergence among all the regions of the EU is rejected with the log $t$ test statistic ($t_b$) equal to -20.1101417, as visible in Table \ref{Table_overall}. We can therefore see that there is no overall convergence in the EU in the measured period.
...
In Figure \ref{clubs_graphic} we compare convergence in two periods, distinguished by the final year used in the \citeauthor{phillips2007transition}'s test. The first period ends in 2015 (Fig. \ref{clubs_graphic}\subref{clubs_graphic_2015}); the second uses data until 2019 \ref{clubs_graphic}\subref{clubs_graphic_2019}. This allows us to compare two important states of the European economy. 2015 was the year by which most of the European countries reached the final recovery after the Great Recession in terms of output per capita. The year 2019, however, represents a point after a consistent growth period and just before the COVID outbreak.
